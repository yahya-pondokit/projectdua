            ...
            <input type="hidden" name="id" value="<?= $id ?>">
              <!-- <div class="box-body"> -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="tempat_lahir" class="form-control" placeholder="Tempat Lahir" value="<?php echo $row['tempat_lahir']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Tanggal Lahir</label>
                  <div class="col-sm-10">
                    <input type="text" name="tanggal_lahir" class="form-control tanggal" placeholder="Tanggal Lahir" value="<?php echo $row['tanggal_lahir']; ?>">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" name="jenis" value="p" value="l" <?= ($row['jenis_kelamin'] = 'p') ? 'checked' : '' ?>>
                        Perempuan
                      </label>
                    </div>
                  </div>
